# svelte-template-smui

This is a project template for [Svelte](https://svelte.dev) apps utilizing [SMUI](https://sveltematerialui.com).

To create a new project based on this template using [degit](https://github.com/Rich-Harris/degit):

```bash
npx degit mj12358/svelte-template-smui svelte-app
cd svelte-app
```
